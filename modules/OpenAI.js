...
Task:
  Determine the best text to replace the "[[SmartComplete]]" text in the "User's Message". Infer the desired text based on the intructions in the "User's Message". If no instructions are present, complete the "User's Message" or treat the "User's message" as a heading.
...
Format: 
  ...
  DO NOT format your text using Markdown or any rendered formating.
`
  ) {
