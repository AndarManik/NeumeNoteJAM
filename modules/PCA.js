...
function projectToTopTwoPCA(data) {
    var pcaResults = PCA.getEigenVectors(data);
    var topTwoVectors = pcaResults.slice(0, 2);
    var projection = PCA.computeAdjustedData(data, ...topTwoVectors);
    return projection.formattedAdjustedData;
}

export default projectToTopTwoPCA;